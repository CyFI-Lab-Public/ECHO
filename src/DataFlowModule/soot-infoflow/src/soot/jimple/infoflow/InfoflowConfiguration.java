...
import soot.jimple.infoflow.cyfi.config.CyfiConfiguration;
...
public class InfoflowConfiguration {
	...
	private CyfiConfiguration cyfiConfiguration = new CyfiConfiguration();
	...
	public void merge(InfoflowConfiguration config) {
		...
		this.cyfiConfiguration = config.cyfiConfiguration;
	...
	/**
	 * Gets the configuration of cyfi declared
	 *
	 * @return The configuration cyfi declared
	 */
	public CyfiConfiguration getCyfiConfiguration() {
		return cyfiConfiguration;
	}

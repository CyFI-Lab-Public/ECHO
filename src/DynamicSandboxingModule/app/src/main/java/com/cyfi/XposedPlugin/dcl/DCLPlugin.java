package com.cyfi.XposedPlugin.dcl;
...
public class DCLPlugin implements IXposedHookLoadPackage {
    @Override
...
//        XposedBridge.log("cyfi autolaunche2r2 injector start on " + packageName);
        ...
        XposedBridge.log("=======Package Name: " + lpparam.packageName + "====== From DCLPlugin");
